"""
Smoke tests for the Adaptive AI Tutor Research Lab.

Goal:
Check that the full project pipeline runs successfully
...
def test_full_pipeline_runs_successfully() -> None:
    """Run the full pipeline and check expected outputs."""
